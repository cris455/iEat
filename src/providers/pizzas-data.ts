...
export class PizzaData{
    ...
    loadData(){
        this.data=[
            ...
            {nombre:"Especial",precio:5000,img:"http://st.depositphotos.com/1557478/4520/i/950/depositphotos_45201411-stock-photo-meat-chicken-and-mushrooms-pizza.jpg"},
            {nombre:"Pepperoni",precio:5000,img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQi6IuRwWYmojJsPp7rmW5chyy5p0qWMjcp9FwM4QS0REfsA8cYtA"},
        ];
    }
}
